...
\subtitle{PhD Thesis Subtitle}
%
% -----------------------------------------------------------------------------
% REQUIRED: Author
% Author full Name
\author{FirstNames MiddleNames LastNames}
%
% -----------------------------------------------------------------------------
% REQUIRED: The SUPERVISOR(s) - maximum of two
\supervisor{{\it Doctor} Supervisor FirstName LastName}
% If no co-Supervisor comment the next line
\othersupervisor{{\it Doctor} Co-Supervisor FirstName LastName}
%
% -----------------------------------------------------------------------------
...
\chairperson{{\it Doctor} Chairperson}
\vogalone{{\it Doctor} Vogal}
%
% -----------------------------------------------------------------------------
